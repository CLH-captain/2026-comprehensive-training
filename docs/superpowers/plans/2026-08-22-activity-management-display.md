...
- [ ] **Step 1: 实现活动分页、筛选和摘要查询**
- [ ] **Step 2: 实现活动详情、状态分布和参与学生查询**
- [ ] **Step 3: 注册路由并运行 Ruff**
...
- [ ] **Step 1: 实现活动摘要、完整筛选、分页表格和状态标识**
- [ ] **Step 2: 实现活动详情抽屉、容量进度、报名/签到结构和参与名单**
- [ ] **Step 3: 注册路由并连接全部现有侧栏**
...
- [ ] **Step 1: 检查活动总数 324、分页记录和详情聚合**
- [ ] **Step 2: 重启服务并验证 `/activities` 为 HTTP 200**
- [ ] **Step 3: 提交活动页面独立里程碑**
