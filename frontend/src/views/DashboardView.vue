...
import campusPhoto from '@/assets/campus/southeast-library.jpg'
...
<template>
  <div class="workspace">
    ...
    <main class="main-content">
      ...
      <section class="hero" :style="{ backgroundImage: `linear-gradient(105deg, rgba(7,79,76,.94), rgba(26,107,101,.82)), url(${campusPhoto})` }">
