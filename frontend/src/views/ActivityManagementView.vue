...
<template>
  <div class="workspace">
    ...
    <main class="main">
      ...
      <section class="panel"><header class="panel-head"><div><small>活动检索</small><h3>活动运行台账</h3></div><span>共 {{ data?.total ?? 0 }} 场</span></header>
